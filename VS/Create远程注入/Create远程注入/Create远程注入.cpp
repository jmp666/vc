...
BEGIN_MESSAGE_MAP(CCreate远程注入App, CWinApp)
...
// 唯一的一个 CCreate远程注入App 对象

CCreate远程注入App theApp;
...
BOOL CCreate远程注入App::InitInstance()
{
